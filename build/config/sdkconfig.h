...
#define CONFIG_EXAMPLE_STATIC_IP_ADDR "192.168.1.5"
...
#define CONFIG_ETHERNET_PHY_INTERFACE_RMII 1
#define CONFIG_ETHERNET_RMII_CLK_INPUT 1
#define CONFIG_ETHERNET_RMII_CLK_GPIO 0
